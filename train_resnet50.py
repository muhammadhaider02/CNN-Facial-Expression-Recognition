...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="FER_resnet50.pth")
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("TrainingGraph_resnet50.png")
        plt.close(fig)
        print("Saved training graph to TrainingGraph_resnet50.png")
